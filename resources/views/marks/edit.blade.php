		...
		<div class="row">
          <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              ...
              <div class="x_content">
                <br>
                <form method="POST" action="{{route('mark.update', $studentsMark->id)}}" id="create-student-form" data-parsley-validate class="form-horizontal form-label-left">
                  @method('PATCH')
                	@csrf
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <select name="student_id" required="required" class="form-control">
                        ...
                        <option value="{{ $value }}" {{$value == $studentsMark->student_id ? 'selected' : ''}}> {{ $student }}</option> 
                        @endforeach                       
                      </select>
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <select name="term_id" required="required" class="form-control">
                        ...
                        <option value="{{ $value }}" {{$value == $studentsMark->term_id ? 'selected' : ''}}> {{ $term }}</option> 
                        @endforeach                       
                      </select>
                    </div>
                  </div>                
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="number" id="maths" name="maths" required="required" value="{{ $studentsMark->maths}}" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="number" id="science" name="science" required="required" class="form-control" value="{{ $studentsMark->science}}">
                    </div>
                  </div>                 

                  <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="computer">Pleas enter History mark <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 ">
                      <input type="number" id="computer" name="computer" required="required" class="form-control" value="{{ $studentsMark->computer}}">
                    </div>
                  </div> 
